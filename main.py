...
def create(world: str, controller: str, supervisor: str, train: bool) -> str:
    """
    ...
    Args:
        ...
        supervisor (str): Supervisor name or path.
    ...
    with open(f"{WORLDS_PATH}/{world}.wbt", "r") as world_file:
        ...
        world_content = world_content.replace("{{SUPERVISOR}}", supervisor)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--supervisor", type=str, required=True, help="Supervisor name or path")
    ...
    world_path = create(args.world, args.controller, args.supervisor, args.train)
