...
from corl.trainer.algorithm.discrete.double_q_learning import TrainerDoubleQLearning
...
class SimpleArenaDoubleQLearning(TrainerDoubleQLearning):
    ...
    Applies online TD updates to two discrete Q-tables after each step using
...
if __name__ == "__main__":
    ...
    SimpleArenaDoubleQLearning(
        config=config,
        model=model,
        checkpoint_frequency=CHECKPOINT_FREQUENCY,
        # checkpoint_id="20260523_184519",
        alpha=ALPHA,
        gamma=GAMMA,
        epsilon=EPSILON,
