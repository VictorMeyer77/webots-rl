...
CRITIC_LR = (
    1e-4  # Critic Adam learning rate — reduced from 3e-4 to prevent critic divergence
)
...
class SimpleArenaPPO(TrainerPPO):
    ...
    the networks. The clipped surrogate objective with multiple mini-batch
    epochs prevents the premature entropy collapse observed with A2C.
    """
