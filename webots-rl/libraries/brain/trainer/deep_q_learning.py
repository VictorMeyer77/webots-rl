...
class TrainerDeepQLearning(Trainer):
    ...
    Attributes:
        model (tf.keras.Model): Main Q-network trained at each step.
        target_model (tf.keras.Model): Target Q-network for stable value estimates,
    ...
    def __init__(
        ...
        Args:
            ...
            model (tf.keras.Model): The Q-network model architecture.
